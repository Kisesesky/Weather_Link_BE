        ...
        try {
            ...
            return {
                ...
                forecasts: forecasts.map(forecast => ({
                    ...
                    skyCondition: SkyCondition[this.getSkyConditionCode(forecast.skyCondition)],
                    precipitationType: PrecipitationType[this.getPrecipitationTypeCode(forecast.precipitationType)]
                }))
            };
        } catch (error) {
