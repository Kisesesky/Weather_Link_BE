...
export class AddAlertSettingAndLog1745202764606 implements MigrationInterface {
    name = 'AddAlertSettingAndLog1745202764606'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "alert_settings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying(20) NOT NULL, "threshold" double precision NOT NULL, "unit" character varying NOT NULL, "condition" character varying NOT NULL, "active" boolean NOT NULL, "userId" uuid, CONSTRAINT "PK_9f318561ba481069150ca1fff62" PRIMARY KEY ("id"))`);
