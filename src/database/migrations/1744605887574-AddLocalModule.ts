...
export class AddLocalModule1744605887574 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_49acb911ee20b02f86ec532a122" FOREIGN KEY ("locationId") REFERENCES "locations_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_49acb911ee20b02f86ec532a122"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "locationId"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "locationId" character varying(255)`);
        await queryRunner.query(`DROP TABLE "locations_entity"`);
        await queryRunner.query(`ALTER TABLE "users" RENAME COLUMN "locationId" TO "location"`);
    }
